...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/easybuy-logo.jpg" alt="易购商城"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverDistrict" value="郫县"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="xxxxx"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="mt10" limit="15">四川成都</div>
						<div class="adr-m" limit="30">郫县 xxxxxxxxx</div>
