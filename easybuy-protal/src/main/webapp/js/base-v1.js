 ...
 */
function login() {
    return location.href = "http://sso.easybuy.com/page/login";
}
function regist() {
    return location.href = "http://sso.easybuy.com/page/register";
}
...
function search(a) {
    var b = "http://localhost:8082/search.html?keyword=" + encodeURIComponent(document.getElementById(a).value);
