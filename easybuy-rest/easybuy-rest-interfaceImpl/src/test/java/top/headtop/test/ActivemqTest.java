...
public class ActivemqTest {
	...
	public void testQueueProducer() throws Exception {
		...
		ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://106.14.115.246:61616");
	...
	public void testTopicProducer() throws Exception {
		...
		Topic topic = session.createTopic("yaorange-topic");
		//6、使用Session对象创建一个Producer对象。
	...
	public void testSpringMQ(){
		...
		jmsTemplate.send(queue, new MessageCreator() {
			...
			public Message createMessage(Session session) throws JMSException {
				TextMessage message = session.createTextMessage("springd的消息");
				return message;
			}
		});
	}
